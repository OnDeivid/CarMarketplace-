...
export default function CatalogCard({ carsData }) {
    return (
        <div key={carsData.id} className="catalog-item">
            <img className='likeCar' src='https://cdn.iconscout.com/icon/free/png-512/free-heart-love-like-favorite-46263.png?f=webp&w=256' />
            <p style={{ color: 'gray', marginTop: '-13px', fontSize: 11 }}>uploaded on: 2.5.2023</p>
            ...
            <div style={{ height: 0.5, width: '100%', backgroundColor: 'gray' }}></div>
